...
<body class="A4 portrait">
    ...
    <section class="sheet padding-15mm">
        <h1 class="center" style="text-decoration: underline;margin-top: 20px;">Laporan Pengadaan</h1>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php if (isset($data['tb_pengadaan']) && !empty($data['tb_pengadaan'])) : ?>
                    <?php $no = 1; ?>
                ...
                <?php else : ?>
                    <tr>
                        <td colspan="8">Tidak ada data pengadaan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
